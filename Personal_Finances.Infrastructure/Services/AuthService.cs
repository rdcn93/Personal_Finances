...
using Personal_Finances.Application.Constants;
...
namespace Personal_Finances.Infrastructure.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<RegistrationResponse> Registrar(RegistrationRequest request)
        {
